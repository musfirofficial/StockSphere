...
#                                Overall Summary                               #
# ---------------------------------------------------------------------------- #
async def generate_overall_summary_report(
    report_in: ReportCreate,
    total_items: int,
    inventroy_cost: float,
    active_items: int,
) -> None: ...
...
# def build_file_path(report_name: str, file_format: FileFormat) -> tuple[str, Path]:
...
#     full_path = (
#         Path(REPORT_BASE_PATH) / file_format.value / f"{report_name}.{extension}"
#     )  # Pathlib used for croos platform comaptibilty
...
#         [
#             "Generated At",
#             datetime.now(timezone(timedelta(hours=5, minutes=30))).strftime(
#                 "%Y-%m-%d %H:%M:%S"
#             ),
#         ],
#     ]
...
#             [
#                 "Note",
#                 "Placeholder report - actual data will be populated in final version",
#             ]
#         )
