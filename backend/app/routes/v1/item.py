...
async def update_existing_item(
    ...
    if "cost_price" in update_data:
        await crud_auditlog.log_item_price_updated(db, current_user, updated_item, "cost_price", old_cost_price, updated_item.cost_price)

    if "selling_price" in update_data:
        await crud_auditlog.log_item_price_updated(db, current_user, updated_item, "selling_price", old_selling_price, updated_item.selling_price)
